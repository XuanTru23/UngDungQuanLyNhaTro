...
public class RCVTenantsAdapter extends RecyclerView.Adapter<RCVTenantsAdapter.ViewHolder>{
    private ArrayList<Tenants> list;

    public RCVTenantsAdapter(ArrayList<Tenants> list) {
        this.list = list;
    }

    private RCVTenantsAdapter.OnItemClickListener listener;
    public interface OnItemClickListener {
        void onItemClick(String idNguoiThue);
    }

    public void setOnItemClickListener(RCVTenantsAdapter.OnItemClickListener listener){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_rcv_tenants, parent,false);
        return new RCVTenantsAdapter.ViewHolder(view);
    }
